        ...
        <div class="section-content">
            <div class="field">
                ...
                <div class="combined-field">
                    ...
                    <input value="'.useIfExist($data, 'req'.$idReq.'-res'.$idRes.'-compare').'" type="text" name="req'.$idReq.'-res'.$idRes.'-compare" id="compare" class="txt-field combined" placeholder="compare">
                </div>
            </div>
            <div class="field">
